...
public interface PositionalLists<T> {
    ...
    /**
     * Inserts element T at the front of the list and returns its new Position.
     */
    Position<T> addFirst(T e);

    /**
     * Inserts element T at the back of the list and returns its new Position.
     */
    Position<T> addLast(T e);

    /**
     * Inserts element T immediately before Position p and returns its new Position.
     */
    Position<T> addBefore(Position<T> p, T e) throws IllegalArgumentException;

    /**
     * Inserts element T immediately after Position p and returns its new Position.
     */
